...
class Render
{
    ...
    public function select($data)
    {
        ...
        return "
			<div class='form-group'>
				<label for=\"$this->name\">$this->label</label>
				<select name='$this->name' $this->required id=\"$this->name\" class=\"form-control select-type $this->class\">
					$option
				</select>   	
			</div>
        ";
    ...
    public function selectbox($id, $tipe_form, $catatan_text, $option, $value_select = "", $name = "")
    {
        ...
        foreach ($option as $key => $value) {
            $opt .= "<option value='$value->value' " . AppHelper::selected($value->value, $value_select) . " >$value->value</option>";
        }
